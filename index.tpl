...
<div class="jumbotron">
 <i class="fa fa-lightbulb-o fa-5x pull-left"></i>
  <h1>I'm MiniDou|迷你豆!</h1>
  ...
  <i class="fa fa-quote-left fa-2x pull-left fa-border icon-muted"></i>
  <p>嗨小伙伴们，这是一个基于豆瓣的可定制的社交网络爬虫与可视化系统。你可以选择你想要的方式抓取特定数量的数据存入TXT文件便于以后的研究或者直接将其可视化，你也可以将它存入图数据库在自己的程序中调用接口。你更可以上传你的数据，让我们帮您分析并且可视化。还在等什么，我们是你分析社交网络的好帮手，<h2><i class="btn fa fa-thumbs-o-up fa-3x pull-left" action="/rate"></i>快来点赞！</h2></p>
